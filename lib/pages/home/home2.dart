...
class HomeSkeleton2 extends StatefulWidget {
  const HomeSkeleton2({Key? key}) : super(key: key);

  @override
  State<HomeSkeleton2> createState() => _HomeSkeleton2State();
}

class _HomeSkeleton2State extends State<HomeSkeleton2> {
